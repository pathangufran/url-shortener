    ...
    def get(self, request: Request, url_id: str) -> Response:
        ...
        logger.info(
            ...
            extra={
                ...
                "url_id": str(url_id),
                "start_date": str(filter_serializer.validated_data.get("start_date")),
                "end_date": str(filter_serializer.validated_data.get("end_date")),
            },
        )
...
@extend_schema(
    ...
    description=(
        "Return paginated click events for a URL owned by the authenticated user."
    ),
    parameters=[
        OpenApiParameter(
            name="start_date",
